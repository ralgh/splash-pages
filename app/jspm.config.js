System.config({
  ...
  "bundlesz": {
    "build": [
      ...
      "components/svg-injector/svg-injector",
    ...
    "app/build": [
      ...
      "npm:react-intl@1.2.0/lib/components/message",
      "npm:react-intl@1.2.0/lib/escape",
      "app/components/link-exists/link-exists",
      "app/components/svg-injector/svg-injector",
      "app/components/intl-link/intl-link",
      "app/pages/faq/merchants/merchants",
      "app/components/translation/translation",
      "app/pages/home/home.fr",
      "app/pages/about/about.en",
      "app/pages/about/about.fr",
      "app/pages/pricing/pricing",
      "npm:locale@0.0.20/lib/index",
      "npm:svg-injector@1.1.2/svg-injector",
      "npm:process@0.10.1",
      "npm:react@0.13.2/lib/warning",
      ...
      "npm:intl-relativeformat@1.1.0/index",
      "npm:intl-format-cache@2.0.4",
      "app/helpers/locale-helper/locale-helper",
      "npm:react@0.13.2/lib/invariant",
      "npm:react@0.13.2/lib/ReactFragment",
      "npm:react@0.13.2/lib/ReactUpdateQueue",
      "npm:react@0.13.2/lib/DOMChildrenOperations",
      ...
      "npm:react@0.13.2",
      "npm:react-router@0.13.2/lib",
      "app/components/intl-message/intl-message",
      "npm:react-router@0.13.2",
      "app/components/header/header",
      "app/components/page/page",
