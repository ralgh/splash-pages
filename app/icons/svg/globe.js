...
export default class GlobeIcon extends React.Component {
  ...
  render() {
    return (
      <svg className={this.props.className} width='64' height='77' viewBox='0 0 64 77' xmlns='http://www.w3.org/2000/svg'>
        <g fill='#0A0B09'>
