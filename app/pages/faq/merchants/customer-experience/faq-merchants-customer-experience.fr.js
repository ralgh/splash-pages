  ...
  render() {
    return (
      <Translation locales='fr'>
        ...
        <p className='para'>
          Votre client peut vous donner ses coordonnées bancaires par internet, par téléphone ou par courrier.
        </p>
        ...
        <p className='para'>
          Avec GoCardless, vous hébergez les pages de paiement sur votre propre site. Il n’y a pas de redirection
          vers notre site. Vous êtes également en contrôle du design de vos pages de paiements.
        </p>
        ...
        <p className='para'>
          Vous pouvez pré-remplir tous les champs de paiements, excepté l’IBAN qui doit être fourni par l’utilisateur.
        </p>
        ...
        <p className='para'>
          GoCardless est en marque blanche, cela dépend donc de la compatibilité avec les mobiles et tablettes de votre site web.
        </p>
