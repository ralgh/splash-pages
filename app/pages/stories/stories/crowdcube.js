    ...
    return (
      <StoryPage
        ...
        <StoryQuote tag='We were spending hours every day managing payments'>
          <p className='para u-margin-Tn'><a href='http://www.crowdcube.com' className='u-link-color-p u-text-underline' target='_blank'>
          ...
          <p className='para'>Before switching to GoCardless, investments were made using bank deposits which were held
          until the relevant pitch had reached its target.</p>
          <p className='para'>Darren Westlake, CEO explains: “It wasn’t the most efficient way of doing things.
        ...
        <StoryQuote tag='GoCardless was simple to integrate into our systems'>
          <p className='para u-margin-Tn'>Looking for a more scalable solution Darren turned to Direct Debit with GoCardless.</p>
          <p className='para'>He explains, “We chose GoCardless because it let us set up payments without taking
          ...
          <p className='para'>Crowdcube now ask all customers to use GoCardless and each of their entrepreneurs has
        ...
        <StoryQuote tag='Switching to GoCardless has helped us completely wipe out payments admin'>
          <p className='para u-margin-Tn'>Since joining GoCardless in November 2012, Crowdcube has grown 1000% to 85,000
          members but the time they have to spend managing payments has all but disappeared.</p>
          <p className='para'>“Switching to GoCardless has helped us completely wipe out payments admin which
