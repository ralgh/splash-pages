...
export default class FoundationOfHeartsStory extends React.Component {
  displayName = 'FoundationOfHeartsStory'
    ...
    return (
      <StoryPage
        ...
        <StoryQuote tag='GoCardless was the simple option'>
          <p>Having spoken to PayPal and their bank about other payment methods the Foundation decided on
          GoCardless as “the simple option”.</p>
          <p>Calum Robertson, a director of the Foundation of Hearts, says, “We chose GoCardless for three
          ...
          <p>The Foundation integrated with the GoCardless API to allow fans to make pledges through their website.
        ...
        <StoryQuote tag='The GoCardless team has been fantastic'>
          <p>Using GoCardless has made the payment process much simpler to manage. “I'm not the most technical of people,
          and even I have found it simple to use. What's more, the quality of service we've received from the GoCardless
          team has been fantastic” says Calum, director of the Foundation.</p>
          <p>Within two months of launching with GoCardless, 7,500 fans pledged to support the Foundation.
